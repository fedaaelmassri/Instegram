...
Route::get('/posts/{id?}','PostController@view')->name('posts');
Route::get('/{id?}','PostController@index')->name('home');
 Route::get('/Category/{id?}','PostController@index')->name('post_category');
 Route::get('/posts.view/{id?}','PostController@view')->name('/posts.view');

// Route::get('/posts','PostController@index')->name('posts')->middleware(['admin','admin']);
// Route::prefix('')->name('home')->group(function() {
// 	Route::get('/','PostController@index')->name('home1');
// 	Route::delete('/{id?}', 'PostController@index')->name('.category');

// });
 Route::get('/posts/{id}','PostController@view')->name('posts.view');
Route::prefix('admin/posts')->namespace('Admin')->name('admin.posts')/*->middleware(['auth:admin'])*/->group(function() {
