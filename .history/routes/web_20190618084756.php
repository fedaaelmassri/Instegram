...
Route::namespacegroup(function(){
    ...
    Route::get('/admin/posts/{id}','Admin/PostController@edit') ;
    Route::put('/admin/posts/{id}','Admin/PostController@update') ;
    Route::put('/admin/posts/{id}','Admin/PostController@delete') ;
});
