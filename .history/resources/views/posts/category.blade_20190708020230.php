             ...
             <div class="col-md-10 col-lg-8 p-b-80">
					<div class="p-r-10 p-r-0-sr991">
						<div class="m-t--40 p-b-40">
                            <!-- Item post -->
                            @foreach($postofcategory as $key=> $category)
                            @foreach($category as $key=> $postocat)
							...
							<div class="flex-wr-sb-s p-t-40 p-b-15 how-bor2">
								...
								<div class="size-w-9 w-full-sr575 m-b-25">
									<h5 class="p-b-12">
										<a href="{{ route('view', ['id' => $post->id]) }}" class="f1-l-1 cl2 hov-cl10 trans-03 respon2">
											{{$postocat->title}} 
										</a>
									</h5>
                                    ...
                                    {{ strlen(strip_tags($postocat->content)) > 50 ? " <a href="{{ route('view', ['id'=> $post->id]) }}" class="f1-s-1 cl9 hov-cl10 trans-03">Read More <i class="m-l-2 fa fa-long-arrow-alt-right"></i></a> " : "" }}
									</p>
