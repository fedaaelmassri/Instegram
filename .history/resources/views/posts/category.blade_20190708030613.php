             ...
             <div class="col-md-10 col-lg-8 p-b-80">
					<div class="p-r-10 p-r-0-sr991">
						<div class="m-t--40 p-b-40">
                            <!-- Item post -->
                            @foreach($postofcategory->posts as $key =>  $postocat)
                                @if($key < 10 )
							<div class="flex-wr-sb-s p-t-40 p-b-15 how-bor2">
								...
								<div class="size-w-9 w-full-sr575 m-b-25">
									...
									<p class="f1-s-1 cl6 p-b-24">
                                            {{ substr(strip_tags($postocat->content), 0, 50) }}

									</p>
                                    <a href="{{ route('view', ['id' => $postocat->id]) }}" class="f1-s-1 cl9 hov-cl10 trans-03">
										Read More
						...
						<div class="p-b-60">
							...
							@foreach($categories as $key=> $category)
								<li class="how-bor3 p-rl-4">
									<a href="{{ route('post_category', ['id' => $category->id]) }}" class="dis-block f1-s-10 text-uppercase cl2 hov-cl10 trans-03 p-tb-13">
										{{$category->title}}
									</a>
								</li>
                              @endforeach
