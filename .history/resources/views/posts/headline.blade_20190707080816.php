...
@section('featurepost')
				...
				<div class="col-md-6 p-rl-1 p-b-2">
					<div class="bg-img1 size-a-3 how1 pos-relative" style="background-image: url({{ asset('storage/'.$posts[0]['image']) }});">
						<a href="{{ route('posts', ['id' => $posts[0]['id']]) }}" class="dis-block how1-child1 trans-03"></a>

						<div class="flex-col-e-s s-full p-rl-25 p-tb-20">
                        @foreach($posts[0]->categories as $category)

							<a href="{{ route('posts', ['id' => $category->id]) }}" class="  dis-block how1-child2 f1-s-2 cl0 bo-all-1 bocl0 hov-btn1 trans-03 p-rl-5 p-t-2 ">
					{{ $category->title }}
                                               </a>
                                               @endforeach

							<h3 class="how1-child2 m-t-14 m-b-10">
								<a href="{{ route('posts', ['id' => $posts[0]['id']]) }}" class="how-txt1 size-a-6 f1-l-1 cl0 hov-cl10 trans-03">
                                {{ $posts[0]['title'] }}								
				...
				<div class="col-md-6 p-rl-1">
					<div class="row m-rl--1">
						<div class="col-12 p-rl-1 p-b-2">
							<div class="bg-img1 size-a-4 how1 pos-relative" style="background-image: url({{ asset('storage/'.$posts[1]['image']) }});">
								<a href="{{ route('posts', ['id' => $posts[1]['id']]) }}"  class="dis-block how1-child1 trans-03">
                                {{ $posts[1]['title'] }}								
					...
					{{ $category->title }}
									...
									<h3 class="how1-child2 m-t-14">
										<a href="{{ route('posts', ['id' => $posts[1]['id']]) }}"  class="how-txt1 size-a-7 f1-l-2 cl0 hov-cl10 trans-03">
                                        {{ $posts[1]['title'] }}								
                                    		</a>
									</h3>
								</div>
						...
						<div class="col-sm-6 p-rl-1 p-b-2">
							<div class="bg-img1 size-a-5 how1 pos-relative" style="background-image: url({{ asset('storage/'.$posts[2]['image']) }});">
								<a href="{{ route('posts/id', ['id' =>$post->id]) }}" class="dis-block how1-child1 trans-03"></a>
         ...
         <a href="{{ route('posts', ['id' => $category->id]) }}" class="  dis-block how1-child2 f1-s-2 cl0 bo-all-1 bocl0 hov-btn1 trans-03 p-rl-5 p-t-2 ">
           {{ $category->title }}
                   ...
                   @endforeach
									...
									<h3 class="how1-child2 m-t-14">
										<a href="{{ route('posts', ['id' => $posts[2]['id']]) }}"  class="how-txt1 size-h-1 f1-m-1 cl0 hov-cl10 trans-03">
                                        {{ $posts[2]['title'] }}									
                                    </a>
										</a>
									</h3>
                 ...
                 {{ $category->title }}
                   ...
                   @endforeach
									...
									<h3 class="how1-child2 m-t-14">
										<a href="{{ route('posts', ['id' => $posts[3]['id']]) }}"  class="how-txt1 size-h-1 f1-m-1 cl0 hov-cl10 trans-03">
                                        {{ $posts[3]['title'] }}						
                                    			</a>
										</a>
									</h3>
								...
								<div class="tab-pane fade show active" id="tab-all" role="tabpanel">
									<div class="row">
										<div class="col-sm-6 p-r-25 p-r-15-sr991">
                                            <!-- Item post -->	
											<div class="m-b-30">
												<a href="{{ route('posts/id', ['id' => $posts[0]['id']]) }}" class="wrap-pic-w hov1 trans-03">
													<img src="{{ asset('storage/'.$posts[0]['image']) }}" width="750" height="540" alt="IMG">
												</a>

												<div class="p-t-20">
													<h5 class="p-b-5">
														<a href="{{ route('posts/id', ['id' => $post->id]) }}" class="f1-m-3 cl2 hov-cl10 trans-03">
                                                         {{$posts[0]['title']}}
                                                     </a>
													</h5>
										...
										<div class="col-sm-6 p-r-25 p-r-15-sr991">
											...
											<div class="flex-wr-sb-s m-b-30">
												<a href="{{ route('posts/id', ['id' => $post->id]) }}" class="size-w-1 wrap-pic-w hov1 trans-03">
													<img src="{{ asset('storage/'.$post->image) }}" alt="IMG">
												</a>

												<div class="size-w-2">
													<h5 class="p-b-5">
														<a href="{{ route('posts/id', ['id' => $post->id]) }}" class="f1-s-5 cl3 hov-cl10 trans-03">
                                                        {{$post->title}}
														</a>
													</h5>
								...
								<div class="tab-pane fade" id="tab-{{$cat->id}}" role="tabpanel">
                                    ...
                                    @foreach (App\Category::all() as  $categoryid)
										...
										<div class="col-sm-6 p-r-25 p-r-15-sr991">
											<!-- Item post -->	
											<div class="m-b-30">
												<a href="{{ route('posts/id', ['id' => $post->id]) }}" class="wrap-pic-w hov1 trans-03">
													<img src="{{asset('storage/'.$post->image) }}" alt="IMG">
												</a>
