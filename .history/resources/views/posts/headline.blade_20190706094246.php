    ...
    <div class="tab01 p-b-20">
							<div class="tab01-head how2 how2-cl1 bocl12 flex-s-c m-r-10 m-r-0-sr991">
                                ...
                                @foreach($categories as $cat)
									<li class="nav-item">
										<a class="nav-link" data-toggle="tab" href="#{{ route('home', ['id' => $cat->id]) }}" role="tab">
                                            {{$cat->title}}
                                        </a>
									</li>
									@endforeach
                           ...
                           {{-- @foreach($categories as $cat)
                            @php
                            $firstimage=$cat->posts[0]->image;
                            $catid=$cat->id;
                            @endphp
                             --}}
                     {{--  @foreach($cat->posts as $postscat) --}}	
						<!-- Tab panes -->
							<div class="tab-content p-t-35">
								<!-- - -->
								<div class="tab-pane fade show active" id="#{{ route('home', ['id' => $catid]) }}" role="tabpanel">
                                {{--endforeach --}}   
                                <div class="row">
										<div class="col-sm-6 p-r-25 p-r-15-sr991">
											...
											<div class="m-b-30">
												<a href="blog-detail-01.html" class="wrap-pic-w hov1 trans-03">
													<img src="{ asset('storage/'.$postofcategory[0]->image) }}" alt="IMG">
												</a>

												<div class="p-t-20">
													<h5 class="p-b-5">
														<a href="blog-detail-01.html" class="f1-m-3 cl2 hov-cl10 trans-03">
                                                        {{$postofcategory[0]->title}}														</a>
													</h5>

													<span class="cl8">
														<a href="#" class="f1-s-4 cl8 hov-cl10 trans-03">
                                                        {{$postofcategory[0]->title}}
														</a>
      ...
      {{--   @foreach($categories[$catid]->posts as $postscat)--}}
