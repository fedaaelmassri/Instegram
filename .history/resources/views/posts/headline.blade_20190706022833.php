                     ...
                     {{--  @foreach($cat->posts as $postscat) --}}	
						<!-- Tab panes -->
							<div class="tab-content p-t-35">
								<!-- - -->
								<div class="tab-pane fade show active" id="#{{$cat->title}}-{{$cat->id}}" role="tabpanel">
                                @endforeach    
                                <div class="row">
										...
										<div class="col-sm-6 p-r-25 p-r-15-sr991">
                                            ...
                                            @foreach($categories->contains($categories->id)->posts as $postscat)
											<div class="flex-wr-sb-s m-b-30">
												<a href="blog-detail-01.html" class="size-w-1 wrap-pic-w hov1 trans-03">
													<img src="{{ asset('storage/'.$postscat->$image) }}" alt="IMG">
												</a>
												...
												<div class="size-w-2">
													...
													<span class="cl8">
                                                    @foreach($postscat->categories as $categoryp)
